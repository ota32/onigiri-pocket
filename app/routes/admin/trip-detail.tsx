...
const tripDetail = ({ loaderData }: Route.ComponentProps) => {
  ...
  return (
    <main className="travel-detail wrapper">
      <Header
        title="Trip Details"
        description="View and edit AI-generated travel plans"></Header>
            ...
            <ChipsDirective>
              {pillItems.map((pill, i) => (
                <ChipDirective
                  ...
                  cssClass={`${pill.bg} !text-base !font-medium !px-4`}></ChipDirective>
              ))}
            </ChipsDirective>
          </ChipListComponent>
            ...
            <li className="ml-1">
              <ChipListComponent>
                <ChipsDirective>
                  <ChipDirective
                    text="4.9/5"
                    cssClass="!bg-yellow-50 !text-yellow-700"></ChipDirective>
                </ChipsDirective>
              </ChipListComponent>
            </li>
          </ul>
